...
function fck(opts) {        
        ...
        return function self(val,reg,msg,name) {
            // console.log(val==''? console.log('aaaaaaaaaaa'): console.log('bbbbbbbbbb'));
            // console.log(old.empty.test(val));
            popmsg=true;
            ...
            if (!val){
                if(arguments.length==0){
                    ...
                    ckstat = false;                    
                    return function(){ return arguments.callee };
                }
            }
            if(val=='end') return ckstat;
